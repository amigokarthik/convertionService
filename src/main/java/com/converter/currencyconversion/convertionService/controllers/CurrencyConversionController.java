package com.converter.currencyconversion.convertionService.controllers;
...
import com.converter.currencyconversion.convertionService.proxies.CurrencyExchangeServiceProxy;
...
public class CurrencyConversionController {
	...
	@Autowired
	private CurrencyExchangeServiceProxy forExProxy;
	...
	public CurrencyConversionBean convertCurrencyFeign(@PathVariable String from, @PathVariable String to, @PathVariable BigDecimal quantity) {
		CurrencyConversionBean response= forExProxy.retrieveExchangeValue(from, to);
